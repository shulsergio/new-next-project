...
let matrixData=[];
    try {
    const fetchedData = await fetchShopMatixData(session.user.shop ||"", session.accessToken);
...
<PromotersMatrixBox matrixData={matrixData??""} sessionCategory={session.user.userType==="AV"?"AV":"DA"}/>
</ComponentWrapper>
<ButtonBox option="link" href="/" >Back</ButtonBox>
</>)
};